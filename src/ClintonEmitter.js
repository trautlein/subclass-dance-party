class ClintonEmitter {
  ...
  step(context) {
    setTimeout(function() {
      ...
      var newClintonSpeed = (Math.floor(Math.random() * 10));
      var newClintonAngle = (Math.floor(Math.random() * 359));
      var newClintonLife = (Math.floor(Math.random() * 20));
      var newClinton = new ClintonDancer(newClintonTop, newClintonLeft, newClintonSpeed, newClintonAngle, newClintonLife);
